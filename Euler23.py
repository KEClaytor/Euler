...
if __name__ == "__main__":
    ...
    for x in xrange(1, 28123):
        ...
        if not issum(x, ablist):
            rtotal += x
            # print repr(x) +"is a sum of abundant numbers."
            # " Current total: "+repr(rtotal)

    print "Total of numbers < 28123 that cannot be expressed"
    " as a sum of abundant numbers is: "+repr(rtotal)
