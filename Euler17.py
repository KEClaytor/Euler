...
def num2word(n):
    waones = ["", "one","two","three","four","five","six","seven","eight","nine"]
    watens = ["", "ten", "twenty", "thirty", "forty", "fifty", "sixty", "seventy", "eighty", "ninety"]
    watwns = ["", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen"]
...
#n = input("Number to conver to string: ")
#print num2word(n)
lower = 1
...
print "The number of letters in the numbers", lower, "to", upper, "is:", total
