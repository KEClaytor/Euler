...
#  in 1900 - we are just computing those between Jan 1st, 1901 and Dec 31, 2000
nfirstsundays = -2

while year < 2001:
    # Now that we have updated to the next sunday...
    #  see if this is the first of a month
    #print "sunday # = " + str(sunday) + " Month = " + str(month) + " Year = " + str(year) + " nfirstsunday = " + str(nfirstsundays)
    if sunday == 1:
        nfirstsundays += 1
        #print "GOT ONE!"
    # increment by a week
...
print "There are " + str(nfirstsundays) + " sundays that fall in on the first of the month in the 20th century."
