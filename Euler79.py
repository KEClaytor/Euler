...
print "3 is 2nd spot, as it never is chosen as an end, and 9 is the second to last as it never begins."
print "the work through the other options... 62 appears and 26 never does..."
print "...scratch head..."
print
